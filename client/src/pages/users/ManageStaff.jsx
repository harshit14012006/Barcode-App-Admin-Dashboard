    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6">
      ...
      >
        ...
        <p className="text-gray-600 text-sm md:text-base">
          Manage your{" "}
          <span className="text-green-600 font-semibold">staff & admins</span>{" "}
          easily with search, filters, export, edit & delete.
        </p>
      </motion.div>
      ...
      {toastMsg && (
        <div
          className={`fixed bottom-6 right-6 bg-gradient-to-r from-green-500 to-orange-400 text-white px-5 py-3 rounded-xl shadow-lg transform transition-all duration-500 ease-out
          ${
            isToastVisible
